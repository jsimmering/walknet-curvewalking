...
front_initial_aep = numpy.array([0.26, 0.2, stance_height])  # for forward walking
...
middle_initial_aep = numpy.array([0.1, 0.28, stance_height])  # for forward walking
middle_initial_pep = numpy.array(
    [middle_initial_aep[0] - 2 * default_stance_distance, 0.28, stance_height])  # -0.07# for forward walking
